...
export const main = async() => {
    ...
    console.log(canvas)
    if (!canvas) {
        console.error('Canvas element is not passed correctly.');
        return;
    }
    ...
    context.configure({
        ...
        size: [canvas.width, canvas.height], // Ensure the canvas size is set correctly
    ...
    function frame() {
        ...
        const renderPassDescriptor = {
            colorAttachments: [{
                ...
                clearValue: { r: 0.0, g: 0.0, b: 0.0, a: 0.0 }, // Fully transparent background
                loadOp: "clear",
                storeOp: "store",
            }],
        }
